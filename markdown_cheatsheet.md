...
To put special attention to a quote from another source, add > at the begining of the line
ex. 
> "this is important quote"
>
> and it continues in netxt lines

### Lists

1. Unordered list asterisk* word enter * next word
ex. 
* milk 
* butter 
* eggs

2. Ordered list - easy just start with numbers :)

   For more depth in list or nesting add 2 space more than preceding one
ex.
* Main
  * extra
...
1. Simply use extra enter (hard break) 
...
2. Two spaces after the line (soft break)
